...
public class Queries {
    ...
    public static final String SELECT_ORDERS_BY_DATE = "SELECT product_type, price, count, gender, produce_type, size, colour, type_name, customer_name, customer_email, customer_phone, delivery_method from orders where date(created_at) = ?;";
